...
export const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    defaultOpen: false,
    items: [
      { href: '/dashboard/loja-online',             label: 'Visão Geral',  icon: '📊', modulo: 'loja_online' },
      { href: '/dashboard/loja-online/produtos',    label: 'Produtos',     icon: '🏷️', modulo: 'loja_online' },
      { href: '/dashboard/loja-online/categorias',  label: 'Categorias',   icon: '🗂', modulo: 'loja_online' },
      { href: '/dashboard/loja-online/aparencia',   label: 'Aparência',    icon: '🎨', modulo: 'loja_online' },
      { href: '/dashboard/loja-online/home',        label: 'Banners / Home', icon: '🖼️', modulo: 'loja_online' },
      { href: '/dashboard/loja-online/estoque',     label: 'Estoque',      icon: '📦', modulo: 'loja_online' },
      { href: '/dashboard/loja-online/dominio',     label: 'Domínio',      icon: '🌐', modulo: 'loja_online' },
      { href: '/dashboard/loja-online/configuracoes', label: 'Configurações', icon: '⚙️', modulo: 'loja_online' },
    ],
  },
  {
    id: 'crm',
